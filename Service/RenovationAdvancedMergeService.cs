...
{
    public class RenovationAdvancedMergeService
    {
        ...
        {
            RenovationAdvancedMergeRepository.Instance.renovation.Add(renovationAdvanced);
        ...
        public bool DeleteRenovationAdvanced(RenovationAdvanced deletedRenovationAdvanced)
        {
            ...
            foreach (RenovationAdvanced renovationAdvanced in RenovationAdvancedMergeRepository.Instance.renovation)
            {
                if (renovationAdvanced.id == deletedRenovationAdvanced.id)
                {
                    RenovationAdvancedMergeRepository.Instance.renovation.Remove(renovationAdvanced);
                    renovationRepository.Save();
                    return true;
                }
            }
